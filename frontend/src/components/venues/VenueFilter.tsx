...
const NEIGHBOURHOODS = ["Gastown", "Granville Strip", "Yaletown", "Coal Harbour", "East Vancouver"];
  ...
  return (
    <aside className="w-full md:w-64 shrink-0">
      <div className="card-surface p-6">
        <p className="text-xs uppercase tracking-widest text-gold mb-4">Music</p>
        ...
        <p className="text-xs uppercase tracking-widest text-gold mb-4">Neighbourhood</p>
